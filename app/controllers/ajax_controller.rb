  ...
  def get_cal_for_all
    ...
    resses.each do |res|
      if res.activity_type == "game"
        ...
        resses_json.push({id: res.id, display_activity: res.display_activity, starts_at: res.starts_at, date: res.date, team_name: team.name, activity_type: res.activity_type})  
      end
